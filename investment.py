...
#This is the Homepage of this App displaying greetings to the User
...
choice = " "      # Assigned an empty string value to choose for operations of this App
   ...
   # Here collects user assigned pin number
...
while Trials != 0:
  ...
  # Here Prompts User for Data collection for withdrawal Transaction           
          elif(choice == "2"):                                                             
  ...
  # Here the VAt takes effect and Deducted from the Wallet         
